...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post tutors_url, params: { tutor: { about: @tutor.about, image_url: @tutor.image_url, name: @tutor.name, price: @tutor.price, subject: @tutor.subject, username: @tutor.username } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { about: @tutor.about, image_url: @tutor.image_url, name: @tutor.name, price: @tutor.price, subject: @tutor.subject, username: @tutor.username } }
